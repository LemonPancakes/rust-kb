...
//use rust_kb::{KnowledgeBase,Statement,Statement::{Fact,Rule}};
//use std::env;
...
//                        if let Ok(_) = kb.assert(Statement::Fact(fact)) {
...
//                        if let Ok(_) = kb.assert(Statement::Rule(rule)) {
